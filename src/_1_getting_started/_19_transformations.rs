...
pub fn transform_function() {
    ...
    let r_mat: Matrix4<f32> = Matrix4::from_angle_z(Deg(90.0));
    let s_mat: Matrix4<f32> = Matrix4::from_scale(0.5);
    let t_mat = s_mat * r_mat; // final  transformation
