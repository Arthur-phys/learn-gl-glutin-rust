...
pub fn different_wrappers_for_diff_textures() {
    // #################
    // Image obtaining #
    // #################
    ...
    let vertex_path = "/home/Arthur/Tesis/learn-opengl-glutin-gl-rust/src/_1_getting_started/shaders/vertex_shader_16.vs";
    let fragment_path = "/home/Arthur/Tesis/learn-opengl-glutin-gl-rust/src/_1_getting_started/shaders/fragment_shader_16.fs";
    ...
    unsafe {
        ...
        gl::TexParameteri(gl::TEXTURE_2D, gl::TEXTURE_WRAP_S, gl::CLAMP_TO_EDGE as i32); //how to wrap in s coordinate
        gl::TexParameteri(gl::TEXTURE_2D, gl::TEXTURE_WRAP_T, gl::CLAMP_TO_EDGE as i32); // how to wrap in t coordinate
        // texture filtering
