...
pub fn transform_over_time() {

    // #############################
    // Creating translation matrix #
    // #############################

    let t_mat: Matrix4<f32> = Matrix4::from_translation(Vector3 {x:0.5,y:-0.5,z:0.0});
    ...
    let vertex_path = "/home/Arthur/Tesis/learn-opengl-glutin-gl-rust/src/_1_getting_started/shaders/vertex_shader_19.vs";
    let fragment_path = "/home/Arthur/Tesis/learn-opengl-glutin-gl-rust/src/_1_getting_started/shaders/fragment_shader_19.fs";
    ...
    unsafe {
        ...
        // Start using matrix
        shader_program.set_mat4("transform", &t_mat);
    }
    ...
    event_loop.run(move |event, _, control_flow| {
        ...
        let fin_mat4 = t_mat * rot_mat4;
        unsafe {
            gl::ClearColor(0.2, 0.3, 0.3, 1.0);
            gl::Clear(gl::COLOR_BUFFER_BIT);
            
            // render
            shader_program.set_mat4("transform", &fin_mat4);
