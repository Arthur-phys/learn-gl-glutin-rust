...
pub fn vary_visibility_uniform() {
    // #################
    // Image obtaining #
    // #################
    ...
    let vertex_path = "/home/Arthur/Tesis/learn-opengl-glutin-gl-rust/src/_1_getting_started/shaders/vertex_shader_18.vs";
    let fragment_path = "/home/Arthur/Tesis/learn-opengl-glutin-gl-rust/src/_1_getting_started/shaders/fragment_shader_18.fs";
            ...
            Event::WindowEvent {event, ..} => match event {
                ...
                WindowEvent::KeyboardInput {input, is_synthetic, ..} => {
                    ...
                    // UP arrow
                        ...
                        visibility = boundary(Boundary::Upper(1.0),visibility + 0.05); 
                        shader_program.set_float("visibility", visibility);
                    // DOWN arrow
                    } else if input.scancode == 108 {
                        visibility = boundary(Boundary::Lower(0.0),visibility - 0.05);
                        shader_program.set_float("visibility", visibility);
                    }
                },
...
fn boundary(boundary: Boundary, arg: f32) -> f32 {
    match boundary {
        Boundary::Lower(b) => {
            if arg < b {
                b
