...
pub fn position_interpolation() {
    ...
    let vertex_path = "/home/Arthur/Tesis/learn-opengl-glutin-gl-rust/src/_1_getting_started/shaders/vertex_shader_12.vs";
    let fragment_path = "/home/Arthur/Tesis/learn-opengl-glutin-gl-rust/src/_1_getting_started/shaders/fragment_shader_12.fs";
    ...
    unsafe {
        ...
        // NOw we have to tell OpenGL how to parse the vertex data. Since it is a 32-ibt floating point array tightly packed. we do as it follows
