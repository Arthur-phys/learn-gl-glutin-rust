...
use cgmath::{self, Matrix4, Deg, Vector3};
...
use image;
use std::{ptr,str,mem,time::Instant};
use crate::shader::*;
...
pub fn double_rotating_containers() {

    // #############################
    // Creating translation matrix #
    // #############################

    let t_mat_1: Matrix4<f32> = Matrix4::from_translation(Vector3 {x:0.5,y:-0.5,z:0.0});
    let t_mat_2: Matrix4<f32> = Matrix4::from_translation(Vector3 {x:-0.5,y:0.5,z:0.0});
    ...
    let vertex_path = "/home/Arthur/Tesis/learn-opengl-glutin-gl-rust/src/_1_getting_started/shaders/vertex_shader_22.vs";
    let fragment_path = "/home/Arthur/Tesis/learn-opengl-glutin-gl-rust/src/_1_getting_started/shaders/fragment_shader_22.fs";
    ...
    unsafe {
        ...
        // Start using matrix
        shader_program.set_mat4("transform", &t_mat_1);
    }
    ...
    event_loop.run(move |event, _, control_flow| {
        ...
        let rot_mat4 = Matrix4::from_angle_z(Deg(time.elapsed().as_millis() as f32));
        let fin_mat4_1 = t_mat_1 * rot_mat4;

        //creation of scaling matrix
        let scale_mat4 = Matrix4::from_scale(time.elapsed().as_secs_f32().sin());
        let fin_mat4_2 = t_mat_2 * scale_mat4;
        unsafe {
            ...
            // render
            // draw first square
            shader_program.set_mat4("transform", &fin_mat4_1);
            gl::DrawElements(gl::TRIANGLES, 6, gl::UNSIGNED_INT, ptr::null());
            
            // draw second square
            shader_program.set_mat4("transform", &fin_mat4_2);
            gl::DrawElements(gl::TRIANGLES, 6, gl::UNSIGNED_INT, ptr::null());
